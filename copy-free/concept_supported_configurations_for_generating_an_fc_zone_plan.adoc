...
image::../media/delete_me_fc_zone_config1.gif[The following figure illustrates a configuration in which the 7-Mode systems, hosts, and cluster are connected to the switches in the same fabric]
...
image::../media/delete_me_fc_zone_config2.gif[The following figure illustrates a configuration in which the 7-Mode systems and cluster are connected to switches in different fabric]
