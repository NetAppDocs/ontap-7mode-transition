...
. During the precommit testing phase of the secondary HA pair, create a disaster recovery relationship between the 7-Mode primary volume and ONTAP secondary volume:
 ...
 .. [[_step_2b]] Use the `job schedule cron create` command to create a job schedule that matches the schedule configured for the 7-Mode SnapMirror relationship.
 .. [[_step_2c]] Use the `snapmirror create` command to create a SnapMirror relationship of type TDP between the 7-Mode primary volume and the ONTAP secondary volume.
...
https://docs.netapp.com/ontap-9/topic/com.netapp.doc.dot-cm-sag/home.html[System administration]
 ...
 .. Use the `snapmirror delete` command to delete the TDP SnapMirror relationship between the 7-Mode primary volume and the ONTAP secondary volume that was created in <<_step_2c,Step 2c>>.
 .. Delete the cron job schedule that was created in <<_step_2b,Step 2b>>:
 +
