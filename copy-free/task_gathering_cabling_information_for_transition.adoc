...
https://hwu.netapp.com[NetApp Hardware Universe]
 ...
 .. [[destination-port]]Plan the destination ports to use for the disk shelf cabling.
+
...
. Go to the data center to physically record the port connections on the 7-Mode controllers and target cluster nodes in the cabling worksheet:
 ...
 .. Record the destination ports to be used for connecting the 7-Mode disk shelves, as planned in the <<destination-port,previous step>>.
