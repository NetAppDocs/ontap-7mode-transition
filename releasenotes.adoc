...
The link:https://library.netapp.com/ecm/ecm_download_file/ECMLP2877318[7-Mode Transition Release Notes] describe new features, upgrade notes, fixed issues, known limitations, and known issues.
